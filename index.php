    ...
    <div class="container-xl">
            ...
            for ($i = $offset; $i < min($offset + $recordsPerPage, $totalRecords); $i++) {
                ...
                <div class="modal fade" id="modalWindowEditRecord<?php echo $res->id; ?>" data-bs-backdrop="static"
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h2 class="modal-title fs-5" id="staticBackdropLabel">Edit a record to the table</h2>
                            ...
                            <form action="?id=<?php echo $res->id; ?>" class="form-add-record" method="post">
                                <div class="mb-4 row">
                                    <div class="col">
                                        ...
                                        <div id="invoiceHelp" class="form-text d-none invalid-feedback">This field must
                                            be numeric
                                        </div>
                                    </div>
                                    <div class="col">
                                        ...
                                        <div id="typeDocHelp" class="form-text d-none invalid-feedback">This field must
                                            be numeric
                                        </div>
                                    </div>
                                </div>
                                <div class="mb-4 row">
                                    <div class="col">
                                        <label for="nameDoc" class="form-label">Name document</label>
                                        <input value="<?php echo $res->name_doc; ?>" type="text" class="form-control"
                                ...
                                <div class="mb-4 row">
                                    <div class="col">
                                        <label for="blank" class="form-label">Blank</label>
                                        <input value="<?php echo $res->blank_cod; ?>" type="text" class="form-control"
                ...
                <!--    Modal Delete Record  -->
                <div class="modal fade" id="modalWindowDeleteRecord<?php echo $res->id; ?>" data-bs-backdrop="static"
                     data-bs-keyboard="false" tabindex="-1"
                     aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <form action="?id=<?php echo $res->id; ?>" method="post">
                                ...
                                <div class="row gap-2">
                                    ...
                                    <button type="submit" class="col btn btn-danger delete-record-btn" name="delete">
                                        Delete
                                    </button>
                                </div>
                            </form>
        ...
        <ul class="pagination">
            ...
            <?php for ($page = 1; $page <= $totalPages; $page++) : ?>
                <li class="page-item"><a href="?page=<?= $page ?>" class="page-link"><?php echo $page; ?></a></li>
            <?php endfor; ?>
            <li class="page-item">
